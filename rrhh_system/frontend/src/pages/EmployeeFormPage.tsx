...
interface EmployeeData {
  ...
  nombre_conyuge: string; tiene_hijos: boolean; fecha_ingreso_inicial: string; fecha_ingreso_vigente: string;
...
const defaultEmployeeState: EmployeeData = {
  ...
  nombre_conyuge: '', tiene_hijos: false, fecha_ingreso_inicial: '', fecha_ingreso_vigente: '',
...
export const EmployeeFormPage: React.FC = () => {
  ...
  const handleNestedChange = (index: number, e: ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>, section: 'familiares' | 'estudios' | 'contratos') => {
  ...
  const validateForm = () => {
    ...
    if (!employeeData.fecha_ingreso_vigente) newErrors.fecha_ingreso_vigente = 'La fecha de ingreso vigente es requerida.';
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div>
            <label htmlFor="fecha_ingreso_vigente" className="block text-sm font-medium text-gray-700">Fecha Ingreso Vigente</label>
            <input type="date" id="fecha_ingreso_vigente" name="fecha_ingreso_vigente" value={employeeData.fecha_ingreso_vigente} onChange={handleChange} className={`${inputStyles} ${errors.fecha_ingreso_vigente ? 'border-red-500' : 'border-gray-300'}`} />
